        ...
        final completeResponse = await ApiService.completeProfile(
          ...
          healthScreening: screens == null
              ...
              : {
                  ...
                  'feelsWellToday': screens.feelsWellToday,
                  'hasEatenRecently': screens.hasEatenRecently,
                  ...
                  'recentMedProcedures': screens.recentMedProcedures.toList(),
                  'medProcedureDetails': screens.medProcedureDetails.map(
                    (key, detail) => MapEntry(key, {
                      'date': detail.date?.toIso8601String(),
                      'dosageOrReason': detail.dosageOrReason,
                    }),
                  ),
                  'hasMajorMedicalHistory': screens.hasMajorMedicalHistory,
                  'majorMedicalHistoryDesc': screens.majorMedicalHistoryDesc,
                  'hasTransfusionOrSurgery': screens.hasTransfusionOrSurgery,
                  'transfusionOrSurgeryDate': screens.transfusionOrSurgeryDate?.toIso8601String(),
                  'transfusionOrSurgeryDesc': screens.transfusionOrSurgeryDesc,
                  'hasTravelOrNeedleStick': screens.hasTravelOrNeedleStick,
                  'travelOrNeedleDate': screens.travelOrNeedleDate?.toIso8601String(),
                  'travelOrNeedleDesc': screens.travelOrNeedleDesc,
